#!/bin/bash
#SBATCH -J SCIGEN_SCREEN_MUL        # Job name
...
#SBATCH -o ./slurm/screen_mul_%j.log
#SBATCH -e ./slurm/screen_mul_%j.err
...
echo "Starting standard multi-run screening (mp_20, pyrochlore): $(date)"
