...
dataset = 'mp_20'
batch_size = 20 # Number of materials to generate in one batch
num_batches_to_samples = 50 # Number of batches to sample
num_materials = batch_size * num_batches_to_samples
save_traj_idx = []  # List of indices to save trajectory
num_run = 1 # Number of runs
idx_start = 10   # Starting index
header = 'sc'   # Header for the label
sc_list = ['pyc']   # List of SCs to generate
...
sc_natm_range = {   # max number of atoms in the unit cell
    ...
    'pyc': [88, 88], # [56, 56],#   # 16 atom for Pyrochlore (cubic)
