...
class BaseModule(pl.LightningModule):   # BaseModule from diffCSP (copied from SCIGEN/)
    ...
    def configure_optimizers(self):
        ...
        # val_loss may not be available initially, causing scheduler errors
        # Once val_loss becomes available, PyTorch Lightning will automatically use it if configured
...
def sample_scigen(self, batch, diff_ratio = 1.0, step_lr = 1e-5):     
    ...
    time_start = self.beta_scheduler.timesteps - 1  #? check later
