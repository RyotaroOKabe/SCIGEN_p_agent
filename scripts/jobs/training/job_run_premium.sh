#!/bin/bash
#SBATCH -J SCIGEN_PY312_TRAIN        # Job name
...
#SBATCH -o ./slurm/scigen_py312_%j.log
#SBATCH -e ./slurm/scigen_py312_%j.err
...
# --- EXECUTION PHASE ---
echo "Starting SCIGEN training at: $(date)"
echo "Command: python scigen/run.py data=mp_20 model=diffusion_w_type expname=test_py312"
echo ""
