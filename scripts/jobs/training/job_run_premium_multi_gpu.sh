#!/bin/bash
#SBATCH -J SCIGEN_PY312_MULTI_GPU    # Job name
...
echo ""
echo "Command: python scigen/run.py data=mp_20 model=diffusion_w_type expname=test_py312_multi_gpu train.pl_trainer.devices=4 train.pl_trainer.strategy=ddp"
echo ""
